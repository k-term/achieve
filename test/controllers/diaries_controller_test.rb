...
class DiariesControllerTest < ActionController::TestCase
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post :create, diary: { auther: @diary.auther, content: @diary.content, date: @diary.date, number: @diary.number }
    end
  ...
  test "should update diary" do
    patch :update, id: @diary, diary: { auther: @diary.auther, content: @diary.content, date: @diary.date, number: @diary.number }
    assert_redirected_to diary_path(assigns(:diary))
  end
